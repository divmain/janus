...
"#;
    ...
    fn test_parse_phase_header_variants() {
        ...
        // No name (just colon) - should get normalized to "Phase 1"
        let result = try_parse_phase_header("Phase 1:");
        assert_eq!(result, Some(("1".to_string(), "Phase 1".to_string())));

        // No separator or name - should get normalized to "Phase 1"
        let result = try_parse_phase_header("Phase 1");
        assert_eq!(result, Some(("1".to_string(), "Phase 1".to_string())));
