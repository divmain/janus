...
- **Semantic search** (optional): Find tickets by intent using AI-powered vector embeddings; runs locally
...
```json
{
  ...
  "tools": {
    "janus*": false  // Disable all Janus MCP tools globally
  },
  "agent": {
    "my-agent": {
      "tools": {
        "janus*": true  // Enable for specific agent
      }
    }
  }
}
